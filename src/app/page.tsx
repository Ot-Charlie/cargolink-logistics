  ...
  return (
    <main className="">
      <section className="heroSection w-full min-h-screen pt-16 pb-10">
        ...
        <div className="flex flex-col items-center gap-6 mt-8 px-6 lg:flex-row lg:justify-around lg:items-center lg:px-16 lg:mt-16">
          ...
          <div className="flex flex-col items-center gap-6 lg:items-start">
            ...
            >
              Safe handling, real-time tracking, and seamless cross-border
              logistics connecting Africa to the world — with complete
              visibility from port to doorstep.
            </p>
      ...
      <section className="w-full bg-background py-12 flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col gap-3 lg:gap-10 lg:flex-row lg:items-center">
          ...
          <div className="flex flex-col gap-4">
            {/* H2 */}
            <h2
              className={`font-urbanist font-semibold text-text-primary max-w-80 lg:max-w-90 ${styles.reliabilityHeading}`}
            >
              Logistics built for{" "}
              <span className="text-accent">reliability</span>, not promises
            </h2>
            ...
            >
              ...
              <span className="text-text-medium font-normal">
                Shipments disappear into transit. Updates arrive late.
                Accountability vanishes at borders.
              </span>
            </p>

            {/* Paragraph 2 */}
            <p
              className={`font-inter font-normal text-text-medium max-w-85 lg:max-w-135 ${styles.bodyText}`}
            >
              We built CargoLink differently. Every shipment is tracked in real
              time. Every handoff is documented. Every partner is vetted.
              Because when you're moving millions in goods, visibility isn't a
              feature — it's the foundation.
            </p>

            {/* Paragraph 3 */}
            <p
              className={`font-inter font-normal text-text-medium max-w-81.5 lg:max-w-130 ${styles.bodyText}`}
            >
              Whether it's air, sea, or road, we operate with one principle:
              your cargo arrives as promised, or we tell you why it didn't.
            </p>
            {/* Bullet Points */}
            <div className="flex flex-col gap-4">
              {/* 4th - Location */}
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p
                    className={`font-inter font-normal text-text-subtle max-w-55 lg:max-w-full ${styles.bulletText}`}
                  >
                    Real-time tracking across all transport modes, with instant
                    alerts.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p
                    className={`font-inter font-normal text-text-subtle max-w-64 lg:max-w-full ${styles.bulletText}`}
                  >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <h3
                    className={`font-inter font-semibold text-text-primary max-w-57 lg:max-w-full ${styles.bulletHeading}`}
                  >
                    Built to operate globally, without breaking down locally.
                  </h3>
                  <p
                    className={`font-inter font-normal text-text-subtle max-w-70 lg:max-w-full ${styles.bulletText}`}
                  >
                    Seamless integration across 120+ countries and 500+
                    logistics hubs.
                  </p>
                </div>
              </div>
      ...
      <section className="bg-background py-16 px-6 flex flex-col items-center">
        ...
        <p
          className={`font-inter font-light text-text-subtle text-center mt-4 max-w-60 ${styles.sectionSubtext}`}
        >
      ...
      <section className="bg-background py-16 px-6 flex flex-col items-center">
        ...
        <p
          className={`font-inter font-light text-text-subtle text-center mt-4 ${styles.sectionSubtext}`}
        >
        ...
        <div className="flex flex-col items-center gap-6 mt-12 w-full lg:flex-row lg:items-center lg:justify-center lg:gap-8">
          ...
          <div className="flex flex-col gap-4 lg:order-1 lg:items-end">
            <div className="flex flex-col gap-3 p-6 rounded-2xl w-83 min-h-52.75 border border-border-shade bg-light-shade">
              ...
              />
              <h3
                className={`font-inter font-semibold text-text-primary ${styles.featureHeading}`}
              >
                Real-time Tracking
              </h3>
              <p
                className={`font-inter font-normal text-text-subtle ${styles.bulletText}`}
              >
                Track your shipment live across air, sea, and road with instant
                status updates at every handoff.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 p-6 rounded-2xl w-83 min-h-52.75 border border-border-shade bg-light-shade">
              ...
              <p
                className={`font-inter font-normal text-text-subtle ${styles.bulletText}`}
              >
                Ship across borders seamlessly with access to trusted logistics
                networks worldwide.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 lg:order-3">
            <div className="flex flex-col gap-3 p-6 rounded-2xl w-83 min-h-52.75 border border-border-shade bg-light-shade">
              ...
              <p
                className={`font-inter font-normal text-text-subtle ${styles.bulletText}`}
              >
                Every partner is vetted, every transfer documented, and every
                shipment handled with care.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 p-6 rounded-2xl w-83 min-h-52.75 border border-border-shade bg-light-shade">
              ...
              <p
                className={`font-inter font-normal text-text-subtle ${styles.bulletText}`}
              >
                Know where your shipment is, who handled it, and what happens
                next — no blind spots.
              </p>
            </div>
          </div>
      ...
      <footer className="bg-footer-bg w-full py-12">
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:justify-around px-6">
          ...
          <div className="flex flex-col gap-4 lg:max-w-75">
            <div className="flex items-center gap-2">
              ...
              />
              <h4
                className={`font-inter text-text-heading ${styles.footerBrand}`}
              >
                CARGOLINK
              </h4>
            </div>
            <p
              className={`font-inter text-footer-text ${styles.footerBrandText}`}
            >
              Premium logistics solutions for the modern world. Connecting
              Africa to global markets with speed, security, and absolute
              visibility.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 lg:flex lg:gap-12">
            ...
            <div className="flex flex-col gap-3">
              <h4
                className={`font-inter text-text-heading ${styles.footerHeading}`}
              >
                Services
              </h4>
              <ul className="flex flex-col gap-2">
                {[
                  ...
                  <li key={item}>
                    <a
                      href="#"
                      className={`font-inter text-footer-text cursor-pointer hover:text-accent transition-colors ${styles.footerLink}`}
                    >
                      {item}
                    </a>
                  </li>
        ...
        <div className="flex flex-col items-center gap-3 mt-10 pt-6 border-t border-footer-text/20 lg:flex-row lg:justify-between px-6">
          <p
            className={`font-inter text-footer-text text-center lg:text-left ${styles.footerLink}`}
          >
